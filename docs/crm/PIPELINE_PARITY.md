...
| Guardar e abrir lead seguinte | implemented | `tests/frontend/test_leads_queue.js` prova que captura lead/versão/sucessor visível antes do POST, preserva a ordem pré-save, só avança após sucesso e não avança em falha |
